         ...
         <div class="breadcrumb-txt">
            <div class="row">
               ...
               @if(($service->background_inner_img!=null)&&($service->video_link== null))
                  <div class="col" >
                     <img style="max-width:100%" src="{{asset('assets/front/img/services/' . $service->background_inner_img)}}" class="img-fluid" alt="">
                  </div>
               @endif

               @if($service->video_link!= null)
               <div class="col">
                  <iframe width="100%" height="315" src="{{$service->video_link}}" frameborder="0"
...
<div class="pt-115 pb-110 service-details-section">
   <div class="container">
     ...
     " class="col-lg-5">
         ...
         <div class="col-lg-7">
            <div style="padding: 0;" class="product-area team_slide team_slick">
