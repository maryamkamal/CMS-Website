        ...
        <div class="container-fluid">
            <div class="top_header">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 px-0 px-lg-3">
                ...
                <div class="site_menu">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-sm-12">
                            <div class="brand">
                                @if($rtl == 1)
                                    <a href="{{route('front.index')}}"><img src="{{asset('assets/front/img/GIFS/ARABIC.gif')}}" class="img-fluid img-img" alt=""></a>
                                @else
                                    <a href="{{route('front.index')}}"><img src="{{asset('assets/front/img/GIFS/English.gif')}}" class="img-fluid img-img" alt=""></a>
                                @endif
                            </div>
                        </div>
