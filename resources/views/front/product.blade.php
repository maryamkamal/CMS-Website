              ...
              <p class="title">{{ $langg->lang87 }} :</p>
                  ...
                  <div class="info-meta-3">
                    <ul class="meta-list">
                      ...
                      @if($productt->emptyStock())
                      <li class="addtocart">
                        <a href="#" class="cart-out-of-stock">
                          <i class="icofont-close-circled"></i>
                          {{ $langg->lang78 }}</a>
                      </li>
                      @else
                      <li class="addtocart">
                        <a href="{{ route('product.cart.add',$productt->id) }}" id=""><i class="icofont-cart"></i>{{ $langg->lang90 }}</a>
                      </li>

                      <li class="addtocart">
                        <a id="" href="{{ route('product.cart.quickadd',$productt->id) }}">
                  ...
                  <div class="contact-seller">
                    ...
                    <ul class="list">
                      ...
                      <li>
                        ...
                        @if(
                        Auth::guard('web')->user()->favorites()->where('vendor_id','=',$productt->user->id)->get()->count() > 0)
