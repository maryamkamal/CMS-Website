...
<div class="page-header">
   <h4 class="page-title">{{ __('trans.Packages') }}</h4>
   ...
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="row">
               <div class="col-lg-4">
                  <div class="card-title d-inline-block">{{ __('trans.Packages') }}</div>
               </div>
               <div class="col-lg-3">
                  @if (!empty($langs))
               ...
               <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                  <a href="#" class="btn btn-primary float-lg-right float-left btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i>{{ __('trans.Add Package') }} </a>
         ...
         <div class="card-body">
            <div class="row">
               <div class="col-lg-12">
                  @if (count($packages) == 0)
                  <h3 class="text-center">{{ __('trans.NO PACKAGE FOUND') }}</h3>
                  @else
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">{{ __('trans.Add Package') }}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>
         <div class="modal-body">
             @if (getVersion($be->theme_version) == 'lawyer')
                <form class="mb-3 dm-uploader drag-and-drop-zone modal-form" enctype="multipart/form-data" action="{{route('admin.package.upload')}}" method="POST">
                    <div class="form-row px-2">
                        ...
                        <label for=""><strong>{{ __('trans.Icon Image') }} **</strong></label>
                        </div>
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.package.store')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <p class="text-warning"><small>{{ __('trans.Order Serial Number') }}</small></p>
               </div>
               <div class="form-group">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">{{ __('trans.Edit Package') }}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>
         <div class="modal-body">
            <form id="ajaxEditForm" class="" action="{{route('admin.package.update')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <p class="text-warning"><small>{{ __('trans.Description') }}</small></p>
               </div>
               <div class="form-group">
                  <label>{{ __('trans.Meta Keywords') }}</label>
