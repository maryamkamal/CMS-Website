...
<div class="page-header">
  ...
  <div class="row" id="app">
    <div class="col-lg-7">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card-title">{{ __('trans.Input Fields') }}</div>
                </div>
                <div class="col-lg-4">
                    @if (!empty($langs))
        ...
        <div class="card-body">
            <p class="text-warning">**{{ __('trans.Do not create') }} <strong class="text-danger">{{ __('trans.Name & Email') }}</strong> input field, it will be in the Package Order form By default.</p>
            ...
            <div class="form-group">
                <label for="">{{ __('trans.NDA file') }} @if($ndaIn->required == 1) <span>**</span> @elseif($ndaIn->required == 0) (Optional) @endif</label>
                <div class="row">
                    <div class="col-md-10">
                        <input type="file">
                    </div>
    ...
    <div class="col-lg-5">
      <div class="card">
        <div class="card-header">
          <div class="card-title">{{ __('trans.Create Input') }}</div>
        </div>
        ...
        <form id="ajaxForm" action="{{route('admin.package.form.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" v-if="counter > 0" id="optionarea">
                ...
                <button type="button" class="btn btn-success btn-sm text-white" @click="addOption()"><i class="fa fa-plus"></i> Add Option{{ __('trans.massa') }}</button>
            </div>

            <div class="form-group text-center">
                <button id="submitBtn" type="submit" class="btn btn-primary btn-sm">{{ __('trans.ADD FIELD') }}</button>
            </div>
        </form>
