...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Sliders') }}</h4>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">{{ __('trans.Sliders') }}</div>
                </div>
                <div class="col-lg-3">
                    @if (!empty($langs))
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-lg-right float-left" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{ __('trans.Add Slider') }}</a>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
              @if (count($sliders) == 0)
                <h3 class="text-center">{{ __('trans.NO SLIDER FOUND') }}</h3>
              @else
                <div class="row">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{ __('trans.Add Slider') }}</h5>
        ...
        <div class="modal-body">
          ...
          <form class="modal-form" id="ajaxForm" action="{{route('admin.slider.store')}}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{ __('trans.Image') }} </label>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bold_text" value="" placeholder={{__('trans.Enter Bold Text')}}>
            ...
            @if (getVersion($be->theme_version) != 'cleaning')
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="text" value="" placeholder={{__('trans.Enter Text')}}>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="button_text" value="" placeholder={{__('trans.Enter Button Text')}}>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control ltr" name="button_url" value="" placeholder={{__('trans.Enter Button URL')}}>
