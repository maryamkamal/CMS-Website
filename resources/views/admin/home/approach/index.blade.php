...
@endif
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <form class="" action="{{route('admin.approach.update', $lang_id)}}" method="post">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  <label>{{ __('trans.Button Text') }}</label>
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  <label>{{ __('trans.Button URL') }}</label>
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('trans.Points') }}</div>
          <a href="#" class="btn btn-primary @if(session('language')=="ar") float-left  @else float-right @endif" data-toggle="modal" data-target="#createPointModal"><i class="fas fa-plus"></i> {{ __('trans.Add Point') }}</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($points) == 0)
                <h2 class="text-center">{{ __('trans.NO POINT ADDED') }}</h2>
              @else
