...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Faqs') }}</h4>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">{{ __('trans.Faqs') }}</div>
                </div>
                <div class="col-lg-3">
                    @if (!empty($langs))
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{ __('trans.Add Faq') }}</a>
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.faq.bulk.delete')}}"><i class="flaticon-interface-5"></i> {{ __('trans.delete') }}</button>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($faqs) == 0)
                <h3 class="text-center">{{ __('trans.NO FAQ FOUND') }}</h3>
              @else
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{ __('trans.Add Faq') }}</h5>
        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form create" action="{{route('admin.faq.store')}}" method="POST">
            ...
            <div class="form-group">
              <label for="">{{ __('trans.Question') }} **</label>
            ...
            <div class="form-group">
              <label for="">{{ __('trans.Answer') }} **</label>
            ...
            <div class="form-group">
              ...
              <p class="text-warning"><small>{{ __('trans.FAQMassage') }}</small></p>
            </div>
          </form>
        </div>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{ __('trans.Edit Faq') }}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="ajaxEditForm" class="" action="{{route('admin.faq.update')}}" method="POST">
            ...
            <div class="form-group">
              ...
              <p class="text-warning"><small>{{ __('trans.FAQMassage') }}T</small></p>
            </div>
          </form>
        </div>
        <div class="modal-footer">
