...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Testimonials') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('trans.Testimonials') }}</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('trans.Testimonials') }}</div>
          <a href="#" class="btn btn-primary @if(session('language') == "ar") float-left @else float-right @endif btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i>{{ __('trans.Add Testimonial') }} </a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($testimonials) == 0)
                <h3 class="text-center">{{ __('trans.NO TESTIMONIAL FOUND') }}</h3>
              @else
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{ __('trans.Add Testimonial') }}</h5>
        ...
        <div class="modal-body">
          <form class="mb-3 dm-uploader drag-and-drop-zone modal-form" enctype="multipart/form-data" action="{{route('admin.testimonial.upload')}}" method="POST">
            ...
            <p class="text-warning mb-0 mt-2">{{ __('trans.Testimonials Img Size') }}</p>
          </form>
          ...
          <form id="ajaxForm" class="modal-form" action="{{route('admin.testimonial.store')}}" method="POST">
            ...
            <div class="form-group">
              ...
              <p class="text-warning"><small>{{ __('trans.Name') }}The higher the serial number is, the later the testimonial will be shown.</small></p>
            </div>
          </form>
        </div>
