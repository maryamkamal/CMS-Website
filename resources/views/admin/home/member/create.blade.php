...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Add Member') }}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('trans.Add Member') }}</div>
            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.member.store')}}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="" placeholder="{{__('trans.Enter name')}}">
                  <p id="errname" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{ __('trans.Rank') }} **</label>
                  <input type="text" class="form-control" name="rank" value="" placeholder="{{__('trans.Enter rank')}}">
                  <p id="errrank" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{ __('trans.Facebook') }}</label>
                  <input type="text" class="form-control ltr" name="facebook" value="" placeholder="{{__('trans.Enter facebook url')}}">
                  <p id="errfacebook" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{ __('trans.Twitter') }}</label>
                  <input type="text" class="form-control ltr" name="twitter" value="" placeholder="{{__('trans.Enter twitter url')}}">
                  <p id="errtwitter" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{ __('trans.Instagram') }}</label>
                  <input type="text" class="form-control ltr" name="instagram" value="" placeholder="{{__('trans.Enter instagram url')}}">
                  <p id="errinstagram" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="">{{ __('trans.Linkedin') }}</label>
                  <input type="text" class="form-control ltr" name="linkedin" value="" placeholder="{{__('trans.Enter linkedin url')}}">
