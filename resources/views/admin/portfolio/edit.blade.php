...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Edit Portfolio') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('trans.Edit Portfolio') }}</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('trans.Edit Portfolio') }}</div>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="form-control ltr" name="status">
                        ...
                        <option value="In Progress" {{$portfolio->status == 'In Progress' ? 'selected' : ''}}>{{ __('trans.In Progress') }}</option>
                        <option value="Completed" {{$portfolio->status == 'Completed' ? 'selected' : ''}}>{{ __('trans.Completed') }}</option>
                      </select>
