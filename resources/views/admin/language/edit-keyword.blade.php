...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Edit Keyword') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('trans.Edit Keyword') }}</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('trans.Edit Language Keyword') }}</div>
          ...
          <div class="form">
            <div class="form-group from-show-notify row">
              <div class="col-12 text-center">
                <button type="button" class="btn btn-success" onclick="document.getElementById('langForm').submit();">{{ __('trans.confirmInfo') }}</button>
              </div>
            </div>
          </div>
        </div>
