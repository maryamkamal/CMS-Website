...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Edit User') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('trans.User Management') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#">{{ __('trans.Edit User') }}</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('trans.Edit User') }}</div>
            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.user.update')}}" method="post">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{ __('trans.Username') }} **</label>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{ __('trans.Email') }} **</label>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{ __('trans.First Name') }} **</label>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{ __('trans.Last Name') }} **</label>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{ __('trans.Role') }} **</label>
                      <select class="form-control" name="role">
                        <option value="" selected disabled>{{ __('trans.Select a Role') }}</option>
