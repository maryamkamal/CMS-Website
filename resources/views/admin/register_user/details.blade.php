...
<div class="page-header">
   <h4 class="page-title">{{ __('trans.Customer Details') }}</h4>
   <ul class="breadcrumbs">
      ...
      <li class="nav-item">
         <a href="{{url()->previous()}}">{{ __('trans.Customers') }}</a>
      </li>
      <li class="separator">
         <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
         <a href="#">{{ __('trans.Customer Details') }}</a>
      </li>
   </ul>

   <a href="{{ url()->previous() }}" class="btn-md btn btn-primary" style="margin-left: auto;">{{ __('trans.Back') }}</a>
</div>
<div class="row">
   <div class="col-md-12">
            <div class="row">
               <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('trans.Customer Details')}}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <strong>{{__('trans.First Name')}} :</strong>
                            </div>
                            <div class="col-lg-6">
                                {{$user->fname}}
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <strong>{{__('trans.Last Name')}} :</strong>
                            </div>
                            <div class="col-lg-6">
                                {{$user->lname}}
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <strong>{{__('trans.Username')}} :</strong>
                            </div>
                            <div class="col-lg-6">
                                {{$user->username}}
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <strong>{{__('trans.Country')}} :</strong>
                            </div>
                            <div class="col-lg-6">
                                {{$user->country}}
                            </div>
               ...
               <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('trans.Shipping Details')}}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-lg-6">
               ...
               <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('trans.Billing Details')}} :</h4>
                    </div>
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-header">
            <h4 class="card-title"> {{ __('trans.Orders of') }}[{{ $user->username}}]</h4>
        </div>
        <div class="card-body">
                ...
                <table class="table table-striped mt-3">
                   <thead>
                      <tr>
                         ...
                         <th scope="col">{{ __('trans.Payment Status') }}</th>
                         <th scope="col">{{ __('trans.Order Status') }}</th>
                         <th scope="col">{{ __('trans.Details') }}</th>
                      </tr>
                   </thead>
                   <tbody>
                      ...
                      <tr>
                         ...
                         <td>
                            <form id="statusForm{{$order->id}}" class="d-inline-block" action="{{route('admin.product.orders.status')}}" method="post">
                               ...
                               <option value="reject" {{$order->order_status == 'reject' ? 'selected' : ''}}>{{ __('trans.Rejected') }}</option>
                               </select>
                            </form>
                         </td>
                         <td>
                            <a href="{{route('admin.product.details',$order->id)}}" class="btn btn-primary btn-sm editbtn"><i class="fas fa-eye"></i>{{ __('trans.View') }}</a>
                         </td>
                      </tr>
                      @endforeach
                   </tbody>
