...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Gallery Images') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('trans.Gallery Image Management') }}</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">{{ __('trans.Gallery Images') }}</div>
                </div>
                <div class="col-lg-3">
                    @if (!empty($langs))
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{ __('trans.Add Image') }}</a>
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.gallery.bulk.delete')}}"><i class="flaticon-interface-5"></i>{{ __('trans.delete') }} </button>
                </div>
            </div>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($galleries) == 0)
                <h3 class="text-center">{{ __('trans.NO IMAGE FOUND') }}</h3>
              @else
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{ __('trans.Add Image') }}</h5>
