...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Quote Page Visibility') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('trans.Quote Page Visibility') }}</a>
      </li>
    </ul>
  </div>
  <div class="row">
      ...
      <div class="card">
        <form action="{{route('admin.quote.visibility.update')}}" method="post">
          ...
          <div class="card-header">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="card-title">{{ __('trans.Quote Page Visibility') }}</div>
                  </div>
              </div>
          </div>
            ...
            <div class="form">
              <div class="form-group from-show-notify row">
                <div class="col-12 text-center">
                  <button type="submit" id="displayNotif" class="btn btn-success">{{ __('trans.Update') }}</button>
                </div>
              </div>
            </div>
          </div>
