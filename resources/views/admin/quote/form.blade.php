  ...
  <div class="row" id="app">
    <div class="col-lg-7">
      <div class="card">
        ...
        <div class="card-body">
            <p class="text-warning">** {{ __('trans.Do not create') }} <strong class="text-danger">{{ __('trans.Name') }} & {{ __('trans.Email') }}</strong> input field, it will be in the Request a Quote form By default.</p>
