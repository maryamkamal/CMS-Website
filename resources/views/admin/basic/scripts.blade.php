...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.scripts') }}</h4>
      ...
      <div class="card">
        <form class="" action="{{route('admin.script.update')}}" method="post">
          ...
          <div class="card-header">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="card-title">{{ __('trans.updatescripts') }}</div>
                  </div>
              </div>
          </div>
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  <label>{{ __('trans.tawkToStatus') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('trans.tawkToScript') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('trans.disqusStatus') }}</label>
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                ...
                <div class="form-group">
                  <label>{{ __('trans.disqusScript') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('trans.googleAnalyticsStatus') }}</label>
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                ...
                <div class="form-group">
                  <label>{{ __('trans.googleAnalyticsScript') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('trans.appziFeedbackStatus') }}</label>
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                ...
                <div class="form-group">
                  <label>{{ __('trans.appziFeedbackScript') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('trans.addThisStatus') }}</label>
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                ...
                <div class="form-group">
                  <label>{{ __('trans.addThisScript') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('trans.googleRecaptchaStatus') }}</label>
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                ...
                <div class="form-group">
                  <label>{{ __('trans.googleRecaptchaSitekey') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('trans.googleRecaptchaSecretkey') }}</label>
                ...
                <div class="form-group">
                    <label>{{ __('trans.facebookPexelStatus') }}</label>
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                ...
                <div class="form-group">
                    <label>{{ __('trans.facebookPexelScript') }}</label>
