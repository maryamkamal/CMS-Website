...
<div class="page-header">
   <h4 class="page-title">{{ __('trans.Create Product') }}</h4>
   <ul class="breadcrumbs">
      ...
      <li class="nav-item">
         <a href="#">{{ __('trans.Create Product') }}</a>
      </li>
   </ul>
</div>
<div class="row">
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="card-title d-inline-block">{{ __('trans.Create Product') }}</div>
               ...
               <div class="col-lg-8 offset-lg-2">
                  ...
                  <form id="ajaxForm" class="" action="{{route('admin.product.store')}}" method="post">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                               ...
                               <select class="form-control ltr" name="status">
                                  ...
                                  <option value="1">{{ __('trans.Show') }}</option>
                                  <option value="0">{{ __('trans.Hide') }}</option>
                               </select>
                     ...
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="form-group">
                              <label for=""> {{ __('trans.Current Price') }} (in {{$abx->base_currency_text}}) **</label>
