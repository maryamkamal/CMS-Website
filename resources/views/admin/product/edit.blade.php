...
@endif
  <div class="page-header">
    <h4 class="page-title">{{ __('trans.Edit Product') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('trans.Edit Product') }}</a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('trans.Edit Product') }}</div>
            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.product.update')}}" method="post">
                   ...
                   <div class="col-lg-6">
                       <div class="form-group">
                          ...
                          <select class="form-control ltr" name="status">
                             ...
                             <option value="1" {{$data->status == 1 ? 'selected' : ''}}>{{ __('trans.Show') }}</option>
                             <option value="0" {{$data->status == 0 ? 'selected' : ''}}>{{ __('trans.Hide') }}</option>
                          </select>
                    ...
                    <div class="col-lg-6">
                       <div class="form-group">
                          <label for="">Title{{ __('trans.Back') }} **</label>
                ...
                <div class="row">
                   <div class="col-lg-6">
                       <div class="form-group">
                          <label for="category">Category{{ __('trans.Back') }} **</label>
                          <select  class="form-control categoryData" name="category_id" id="category">
                             <option value="" selected disabled>Select a category{{ __('trans.Back') }}</option>
                   ...
                   <div class="col-lg-6">
                      <div class="form-group">
                         <label for="">{{ __('trans.Stock Product') }} **</label>
                ...
                <div class="row">
                   <div class="col-lg-6">
                      <div class="form-group">
                        <label for=""> {{ __('trans.Product Sku') }} **</label>
                ...
                <div class="row">
                   <div class="col-lg-6">
                      <div class="form-group">
                         <label for=""> {{ __('trans.Current Price') }} (in {{$abx->base_currency_text}}){{ __('trans.Back') }} **</label>
                   ...
                   <div class="col-lg-6">
                      <div class="form-group">
                         <label for="">{{ __('trans.Previous Price') }} (in {{$abx->base_currency_text}})</label>
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <div class="form-group">
                         <label for="summary">{{ __('trans.Summary') }} **</label>
