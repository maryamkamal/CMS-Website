...
<div class="page-header">
   <h4 class="page-title">{{ __('trans.Blogs') }}Blogs</h4>
   ...
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="row">
               <div class="col-lg-4">
                  <div class="card-title d-inline-block">{{ __('trans.Blogs') }}</div>
               </div>
               <div class="col-lg-3">
                  @if (!empty($langs))
               ...
               <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                  <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i>{{ __('trans.Add Blog') }} </a>
                  <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.blog.bulk.delete')}}"><i class="flaticon-interface-5"></i> {{ __('trans.delete') }}</button>
               </div>
            </div>
         </div>
         <div class="card-body">
            <div class="row">
               <div class="col-lg-12">
                  @if (count($blogs) == 0)
                  <h3 class="text-center">{{ __('trans.NO BLOG FOUND') }}</h3>
                  @else
                     ...
                     <table class="table table-striped mt-3">
                        <thead>
                           <tr>
                              ...
                              <th scope="col">{{ __('trans.Publish Date') }}</th>
   ...
   <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">{{ __('trans.Add Blog') }}</h5>
         ...
         <div class="modal-body">
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.blog.store')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" placeholder="{{__('trans.Enter title')}}" value="">
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control summernote" name="content" rows="8" cols="80" placeholder="{{__('trans.Enter content')}}"></textarea>
               ...
               <div class="form-group">
                  ...
                  <p class="text-warning mb-0"><small>{{ __('trans.SerialNumberStru') }}</small></p>
               </div>
               <div class="form-group">
