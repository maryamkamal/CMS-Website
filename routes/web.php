...
//smart routes
  Route::get('/smart/support', 'Admin\SmartController@support')->name('admin.smart.support');
  Route::get('/smart/marketing', 'Admin\SmartController@marketing')->name('admin.smart.marketing');
  Route::get('/smart/problem', 'Admin\SmartController@problem')->name('admin.smart.problem');
  Route::get('/smart/explain', 'Admin\SmartController@explain')->name('admin.smart.explain');
  ...
  Route::group(['middleware' => 'checkpermission:Pages'], function() {
	...
	Route::post('/page/uploadBackground', 'Admin\PageController@uploadBackground')->name('admin.page.uploadBackground');
    Route::post('/page/uploadInnerImg', 'Admin\PageController@uploadInnerImg')->name('admin.page.uploadInnerImg');
    Route::post('/page/{id}/updateBackground', 'Admin\PageController@updateBackground')->name('admin.page.updateBackground');
     Route::post('/page/{id}/updateInnerImg', 'Admin\PageController@updateInnerImg')->name('admin.page.updateInnerImg');
  });
  ...
  Route::group(['middleware' => 'checkpermission:Service Page'], function() {
	...
	Route::post('/service/uploadBackground', 'Admin\ServiceController@uploadBackground')->name('admin.service.uploadBackground');
    Route::post('/service/uploadInnerImg', 'Admin\ServiceController@uploadInnerImg')->name('admin.service.uploadInnerImg');
	...
	Route::post('/service/{id}/updateBackground', 'Admin\ServiceController@updateBackground')->name('admin.service.updateBackground');
    Route::post('/service/{id}/updateInnerImg', 'Admin\ServiceController@updateInnerImg')->name('admin.service.updateInnerImg');
