...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$service->background_img =$request->session()->get('background_img');
        $service->background_inner_img =$request->session()->get('inner_img');
...
public function uploadBackground(Request $request)
    ...
    public function uploadInnerImg(Request $request)
    {
        ...
        $filename = time() . '.' . $img->getClientOriginalExtension();
        $request->session()->put('inner_img', $filename);
        $request->file('file')->move('assets/front/img/services/', $filename);
...
public function updateBackground(Request $request, $id)
    {
        ...
        if ($request->hasFile('file')) {
           ...
           // @unlink('assets/front/img/services/' . $service->background_img);
            $service->background_img = $filename;
            $service->save();
        }
    ...
    public function updateInnerImg(Request $request, $id)
    {
        ...
        if ($request->hasFile('file')) {
         ...
         //   @unlink('assets/front/img/services/' . $service->backgroung_inner_img);
            ...
            $service->background_inner_img = $filename;
            $service->save();
        }
